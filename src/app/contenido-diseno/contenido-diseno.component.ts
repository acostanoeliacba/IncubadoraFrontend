...
@Component({
  selector: 'app-contenido-diseno',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './contenido-diseno.component.html',
  styleUrl: './contenido-diseno.component.css'
})
export class ContenidoDisenoComponent implements OnInit {
  curso: any;
  ...
  ngOnInit() {
    this.curso = {
      ...
      materiales: [
        { nombre: 'Programa PDF', link: '/assets/programa-diseno.pdf' },
        { nombre: 'Presentación PPT', link: '/assets/unidad1-diseno.ppt' }
      ],
      mensajes: [
